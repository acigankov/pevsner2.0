                    ...
                    <div class="menu-cards-content__item card shadow">
                        <div class="card-body">
                            ...
                            <div class="card-link align-items-center justify-content-center d-flex w-100 p-4">
                                ...
                                <a href="/order.php?order=<?= $foodset['id'] ?>"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="pevsner__text">
                        ...
                        <ul>
                            <li>Доставка осуществляется бесплатно в пределах 5 км от МКАД.</li>
                            <li>Для адресов дальше 5 км от МКАД стоимость доставки составляет 20 руб./км от МКАД.</li>
                        </ul>
                    </div>
                </div>
            </div>
