            ...
            <div class="container bg-color-footer">
                <div class="row">
                    <div class="footer-top-line">
                        <div class="logo"><a href="/"><img src="img/design/logo/logo.png" alt="logo" class="img-fluid"></a></div>
                    ...
                    <div class="footer-content w-100 d-flex align-items-center justify-content-between text-center">
                        <div class="footer-content-info">
                            <div class="footer-content-info__email">
                                <a href="mailto:zakaz@pevsner.ru?subject=Вопрос&nbsp;с&nbsp;сайта&nbsp;pevsner.ru" target="_blank" title="E-mail"><span><i class="fas fa-envelope"></i></span> zakaz@pevsner.ru</a>
                                <span class="footer-content-info__hours align-items-center d-flex justify-content-center"><i class="fas fa-business-time"></i> &nbsp; 09:00 - 21:00</span>
                            </div>
                            <div class="footer-content-info__contact d-flex text-left align-items-center justify-content-around py-2">
                                <span>По любым вопросам <br> пишите сюда:</span>
                                <?php $showWAphone = false; ?>
                                <?php if($showWAphone) : ?>
                                    <a href="https://sapp.com/send?phone=79257390201" target="_blank" title="WhatsApp" class="footer-content-info-soc__link"> <i class="fab fa-whatsapp"></i> </a>
                                <?php endif ?>
                                <a href="mailto:zakaz@pevsner.ru?subject=Вопрос&nbsp;с&nbsp;сайта&nbsp;pevsner.ru" target="_blank" title="E-mail" class="footer-content-info-soc__link"> <i class="far fa-envelope"></i> </a>

                            </div>
                        </div>

                        <div class="footer-content__img p-2 d-none d-sm-flex">
                            <img src="img/design/sections/footer/cloud.png" alt="Мы принимаем MasterCard" class="img-fluid">
                        </div>
                        ...
                        <div class="footer-content__add">
                            ...
                            <p>Внешний вид блюда может отличаться от
                                фотографий, представленных на сайте. Цены в рекламных материалах на сайте являются усредненными показателями и не являются
                                публичной офертой
                            </p>
        ...
        <?php if ($_SERVER['HTTP_HOST'] === 'pevsner.ru'): ?>
            ...
            <noscript><div><img src="https://mc.yandex.ru/watch/54740014" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
            <!-- /Yandex.Metrika counter -->
